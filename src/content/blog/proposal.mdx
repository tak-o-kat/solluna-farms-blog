...
- Christian (Tako) - Full Stack Software Developer
  Created Blocki an app that determines the number of blocks proposed to the chain by a node. Runs various Algorand participation nodes since late 2021 and has assisted other with their participation nodes.
